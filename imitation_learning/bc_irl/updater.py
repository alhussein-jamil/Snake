            ...
            for inner_i in range(self.n_inner_iters):
                ...
                if inner_i != self.n_inner_iters - 1:
                    ...
                    for step_idx in range(self.num_steps):
                        ...
                        step_act = TensorDict({"action" : act_data["actions"]}, batch_size=(self.num_envs), device=self.device)
                        ...
                        new_rollouts.insert(next_obs,  torch.zeros((self.num_envs, 1)), done, info, **act_data)
